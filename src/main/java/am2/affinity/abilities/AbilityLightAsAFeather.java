...
public class AbilityLightAsAFeather extends AbstractAffinityAbility {
	...
	public void applyPreSpellCast(EntityPlayer ent, Pre event) {
		if (ent.worldObj.isRaining() && !ent.worldObj.isRemote && ent.worldObj.getBiomeGenForCoords(ent.getPosition()).canRain() && !ent.worldObj.isRemote && ent.worldObj.rand.nextInt(100) < 10){
