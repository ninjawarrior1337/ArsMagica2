package am2.client.guis;

import am2.AMCore;
import am2.api.SkillTreeEntry;
import am2.api.spell.component.interfaces.ISkillTreeEntry;
import am2.api.spell.enums.LearnStates;
import am2.client.guis.controls.GuiButtonCompendiumLink;
import am2.client.guis.controls.GuiButtonCompendiumNext;
import am2.client.guis.controls.GuiButtonCompendiumTab;
import am2.client.guis.controls.GuiSpellImageButton;
import am2.lore.*;
...
public class GuiCompendiumIndex extends GuiScreen implements GuiYesNoCallback{
	...
	private void openLink(URI par1URI){
		try{
			...
			oclass.getMethod("browse", new Class[]{URI.class}).invoke(object, par1URI);
	...
	private void storeBreadcrumb(){
		AMGuiHelper.instance.pushCompendiumBreadcrumb("", this.page, AMGuiHelper.CompendiumBreadcrumb.TYPE_INDEX, activeCategory, activeCategoryID, currentParentEntryName, pagingData);
	}
